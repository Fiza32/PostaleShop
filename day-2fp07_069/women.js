...
let baseserverurl = `https://63c9170d320a0c4c9540575f.mockapi.io/products`
...
function womendata(data){
  let womenata =  data.filter((item)=>item.category=="women")
  console.log(womenata);
  maping(womenata)
  ...
  localStorage.setItem("datas",JSON.stringify(womenata))
}
...
let datos = JSON.parse(localStorage.getItem("datas"))
